...
<div class="fieldcontain ${hasErrors(bean: relationInstance, field: 'fromPerson', 'error')} required">
	...
	<g:select id="fromPerson" name="fromPerson.id" from="${edu.furman.classics.Person.list()}" optionKey="id" required="" value="${relationInstance?.fromPerson?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: relationInstance, field: 'toPerson', 'error')} required">
	...
	<g:select id="toPerson" name="toPerson.id" from="${edu.furman.classics.Person.list()}" optionKey="id" required="" value="${relationInstance?.toPerson?.id}" class="many-to-one"/>
