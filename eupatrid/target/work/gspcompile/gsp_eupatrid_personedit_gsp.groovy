...
class gsp_eupatrid_personedit_gsp extends GroovyPage {
...
invokeTag('eachError','g',26,['bean':(personInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',28,['bean':(personInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
invokeTag('hiddenField','g',30,['name':("version"),'value':(personInstance?.version)],-1)
printHtmlPart(20)
...
invokeTag('form','g',37,['url':([resource:personInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(23)
})
...
public static final long LAST_MODIFIED = 1412557189000L
