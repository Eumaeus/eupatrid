...
class gsp_eupatrid_locationedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/location/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',6,['var':("entityName"),'value':(message(code: 'location.label', default: 'Location'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',26,['bean':(locationInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',28,['bean':(locationInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
invokeTag('hiddenField','g',30,['name':("version"),'value':(locationInstance?.version)],-1)
printHtmlPart(20)
...
invokeTag('form','g',37,['url':([resource:locationInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(23)
})
...
public static final long LAST_MODIFIED = 1412557155000L
