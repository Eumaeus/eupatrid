...
class gsp_eupatrid_personcreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',24,['bean':(personInstance),'var':("error")],3)
printHtmlPart(17)
})
invokeTag('hasErrors','g',26,['bean':(personInstance)],2)
printHtmlPart(10)
createTagBody(2, {->
printHtmlPart(18)
...
invokeTag('form','g',34,['url':([resource:personInstance, action:'save'])],2)
printHtmlPart(21)
})
...
public static final long LAST_MODIFIED = 1412557184000L
