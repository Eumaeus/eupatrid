...
class gsp_eupatriderror_gsp extends GroovyPage {
...
if(true && (exception)) {
printHtmlPart(19)
for( _it1108871177 in (exception.stackTraceLines) ) {
changeItVariable(_it1108871177)
...
public static final long LAST_MODIFIED = 1297862046000L
