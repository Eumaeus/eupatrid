...
class gsp_eupatrid_editorcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/editor/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'editor.label', default: 'Editor'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',24,['bean':(editorInstance),'var':("error")],3)
printHtmlPart(17)
})
invokeTag('hasErrors','g',26,['bean':(editorInstance)],2)
printHtmlPart(10)
createTagBody(2, {->
printHtmlPart(18)
...
invokeTag('form','g',34,['url':([resource:editorInstance, action:'save'])],2)
printHtmlPart(21)
})
...
public static final long LAST_MODIFIED = 1412556631000L
